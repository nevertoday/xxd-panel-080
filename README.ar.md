...
# 🦁 XXD Panel 080｜حقل الغواش العضوي

### يعيد بناء جوهر الصورة العاطفي بأشكال عضوية وألوان نباتية وغواش رقمي وفراغ شاعري
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 080 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تحوّل الرسوم التجارية المعتادة الصورة غالباً إلى قالب مصقول، أو تملأ اللوحة بالنباتات والرموز والخلفية من دون أن تقرأ فعلاً شعور الصورة واستعارتها الكامنة.

يستخدم **Panel 080** الذاكرة الانتقائية لاستخلاص العنصر والبنية والوضعيّة والعلاقة السردية واستعارة رقيقة واحدة تنبع طبيعياً من الصورة. ثم يعيد بناءها بهندسة عضوية مرنة وكتل لونية مسطحة بلا محيط وغواش أو كرايون رقمي ونسيج حبيبي. يؤسس أخضر المريمية والزيتون قاعدة نباتية، وتضيء لمسات دافئة قليلة الشعور، بينما يحمل الفراغ الواسع الهواء والزمن والمسافة والصمت.

### مناسب لـ

- تحويل الشعور إلى علاقات بصرية ظاهرة من خلال المقياس والمسافة والأشكال الموجبة والسالبة والفراغ؛
- استخلاص استعارة طبيعية من النبات أو الطريق أو الأشكال المتكررة أو الحجب أو الأشياء الصغيرة البعيدة من دون فرض قصة جديدة؛
- غواش رقمي وألوان نباتية تصوغها الهندسة العضوية والحبيبات وأخضر المريمية ولمسات دافئة مقتصدة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 080 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** هندسة عضوية لينة · غواش رقمي وشمع · نسيج حبيبي · ألوان نباتية · استعارة من الصورة · فراغ عاطفي
...
|---|---|
| **الناتج** | ملصق شعوري هادئ ولطيف ومفعم بالحياة، بتكوين ناضج وحس للنشر الفني |
| **البصمة الواضحة** | كتل عضوية مرنة، وغواش رقمي حبيبي، ولوحة نباتية منخفضة التشبع، وفراغ واسع يحمل السرد |
| **احترام المصدر** | يحفظ هوية العنصر وعلاقته السردية؛ وتأتي الاستعارة وحرارة اللون العامة من الصورة بدلاً من فرض قصة جديدة |
...
```text
استخلاص الهوية والبنية والوضعيّة والعلاقة السردية والشعور الجوهري → إيجاد استعارة رقيقة تنبع طبيعياً من الأصل → التلخيص بهندسة عضوية مرنة وكتل لونية بلا محيط → إضافة الغواش الرقمي والكرايون والحبيبات اليدوية → إعادة مزج ألوان الأصل بلوحة نباتية منخفضة التشبع → جعل الفراغ يحمل الهواء والزمن والخيال → استخدام نص قليل كحاشية شعورية
```

## سمات النتيجة النهائية

- يُلخّص العنصر بهندسة عضوية مرنة وظلال شكلية واسعة وكتل لونية بلا محيط، مع تخفيف المنظور الحقيقي والضوء والظل الواقعيين.
- يمنح الغواش الرقمي وآثار الكرايون والضوضاء الحبيبية دفء العمل اليدوي الحقيقي، بعيداً عن نعومة الرسوم المتجهية المصقولة.
- يتقدم أخضر المريمية والزيتون، وتدعمه درجات الأصفر الكريمي والأزرق الرمادي والمحايدات، مع لمسات صغيرة من المرجاني أو المشمشي أو الخردلي لإضاءة الشعور.
- يمكن تصغير العنصر أو إزاحته أو قصه أو عزله، ويحمل الفراغ بفاعلية الهواء والزمن والمسافة والصمت والخيال.
- يجب أن تنبع الاستعارة طبيعياً من الصورة، وتبقى الكتابة ملاحظة أو حاشية شعورية خفيفة وصغيرة ومقتصدة.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-080-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 080. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-080 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-080 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-080 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-080 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-080 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 080 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-080 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-080`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-080-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-080-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ80 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 080 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–080) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
