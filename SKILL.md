...
```text
/xxd-panel-080 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，080 设计在下）
2. 左右对照（原图在左，080 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-080/<fresh-task>/
...
- `references/xxd-panel-080-prompt.zh-CN.md`
- `references/xxd-panel-080-prompt.en.md`
